...
//           </div>
//           <button className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition-colors">
//             <TbPlus size={18} />
//             Post New Job
//           </button>
//         </div>
...
//                 <TbDownload size={18} className="text-gray-500" />
//               </button>
//               <button 
//                 onClick={fetchJobs}
...
//                       </button>
//                       <button
//                         onClick={() => window.location.href = `/jobs/${job.id}/manage`}
